;(function () {
    ...
    //所有的取消预约操作，取消预约数据后刷新页面
    if ($('a.js-ajax-cancel').length) {
        Wind.use('artDialog', function () {
            $('.js-ajax-cancel').on('click', function (e) {
                e.preventDefault();
                var $_this = this,
                    $this = $($_this),
                    href = $this.data('href'),
    ...
    //所有的支付操作，支付后刷新页面
    if ($('a.js-ajax-payfor').length) {
        Wind.use('artDialog', function () {
            $('.js-ajax-payfor').on('click', function (e) {
                e.preventDefault();
                var $_this = this,
                    $this = $($_this),
                    href = $this.data('href'),
    ...
    //所有的就诊操作，就诊后刷新页面
    if ($('a.js-ajax-treatment').length) {
        Wind.use('artDialog', function () {
            $('.js-ajax-treatment').on('click', function (e) {
                e.preventDefault();
                var $_this = this,
                    $this = $($_this),
                    href = $this.data('href'),
