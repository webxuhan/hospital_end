...
<html>
	<head>
		...
		<link href="/hospital_end/src/admin/themes/simplebootx/Public/assets/css/admin_login.css" rel="stylesheet" />
		<style>
			#login_btn_wraper{
				text-align: center;
			}
...
<script type="text/javascript" src="/hospital_end/src/public/js/common.js"></script>
<script>
;(function(){
