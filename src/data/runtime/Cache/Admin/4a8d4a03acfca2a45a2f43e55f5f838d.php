...
<body>
							...
							<fieldset>
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<?php if(!empty($site_admin_url_password)): ?><span class="help-block">后台地址：<span id="js-site-admin-url"><?php echo sp_get_host();?>/appoint/src?g=admin&upw=<?php echo C('SP_SITE_ADMIN_URL_PASSWORD');?></span></span><?php endif; ?>
									</div>
								</div>
								...
								<!--                  site option       -->
								<div class="control-group">
									<label class="control-label"><?php echo L('LABEL_PRINT');?>：</label>
									<?php $label_print_yes=$label_print==1?"checked":""; $label_print_no=empty($label_print)?"checked":""; ?>
									<div class="controls">
										<label class="radio inline" for="active_true"><input type="radio" name="options[label_print]" value="1"  <?php echo ($label_print_yes); ?> /><?php echo L('ENABLED');?></label>
										<label class="radio inline" for="active_false"><input type="radio" name="options[label_print]" value="0" <?php echo ($label_print_no); ?>><?php echo L('DISABLED');?></label>
									</div>
								</div>

								<div class="control-group">
									<label class="control-label"><?php echo L('DELIVERY_PRINT');?>：</label>
									<?php $delivery_print_yes=$delivery_print==1?"checked":""; $delivery_print_no=empty($delivery_print)?"checked":""; ?>
									<div class="controls">
										<label class="radio inline" for="active_true"><input type="radio" name="options[delivery_print]" value="1" <?php echo ($delivery_print_yes); ?> /><?php echo L('ENABLED');?></label>
										<label class="radio inline" for="active_false"><input type="radio" name="options[delivery_print]" value="0" <?php echo ($delivery_print_no); ?>><?php echo L('DISABLED');?></label>
									</div>
								</div>

								<div class="control-group">
									<label class="control-label"><?php echo L('SEARCH_OPTION');?></label>
									<?php switch ($search_option) { case 0: $a_selected ="selected"; break; case 1: $b_selected ="selected"; break; case 2: $c_selected ="selected"; break; case 3: $d_selected ="selected"; break; } ?>
									<div class="controls">
										<select name="options[search_option]">
											<option value="0" <?php echo ($a_selected); ?>><?php echo L('SEARCH_OPTION_DEFAULT');?></option>
											<option value="1" <?php echo ($b_selected); ?>><?php echo L('SEARCH_OPTION_ACCURACY');?></option>
											<option value="2" <?php echo ($c_selected); ?>><?php echo L('SEARCH_OPTION_RIGHT');?></option>
											<option value="3" <?php echo ($d_selected); ?>><?php echo L('SEARCH_OPTION_LEFT');?></option>
	...
	<script type="text/javascript" src="/appoint/src/public/js/common.js"></script>
	<script>
		/////---------------------
		$(function(){
