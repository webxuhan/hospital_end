...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo U('Treatment/yettreat');?>">已就诊</a></li>
		</ul>
		<form class="well form-search" method="post" action="<?php echo U('Treatment/yettreat');?>">
			<table>
				<tr>
					<td>挂号单号:</td>
					<td>
		            ...
		            <a class="btn btn-danger" href="<?php echo U('Treatment/yettreat');?>">清空</a>
		            </td>       
	            </tr>
            </table>
		...
		<form class="js-ajax-form" action="<?php echo U('Treatment/yettreat');?>" method="post" id="form2">
