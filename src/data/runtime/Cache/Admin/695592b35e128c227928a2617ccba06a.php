...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="<?php echo U('Disease/add');?>">添加</a></li>
		</ul>
		<form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('Disease/add_post');?>">
			<fieldset>
				...
				<div class="control-group">
					...
					<div class="controls form-group">
						...
						<select name="bdept_id">
							...
							<?php if(is_array($dept)): foreach($dept as $key=>$dp): ?><option value="<?php echo ($dp["bdept_id"]); ?>"><?php echo ($dp["bdept_name"]); ?></option><?php endforeach; endif; ?>
						</select>
					</div>
				</div>	
				<div class="control-group">
