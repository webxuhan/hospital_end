...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo U('Treatment/index');?>">未就诊</a></li>
		</ul>
		<form class="well form-search" method="post" action="<?php echo U('Treatment/index');?>">
			<table>
				<tr>
					<td>挂号单号:</td>
					<td>
		            ...
		            <a class="btn btn-danger" href="<?php echo U('Treatment/index');?>">清空</a>
		            </td>       
	            </tr>
            </table>
		...
		<form class="js-ajax-form" action="<?php echo U('Treatment/index');?>" method="post" id="form2">
			...
			<table class="table table-hover table-bordered table-list" style="width:120%;">
				...
				<tbody>
					...
					<td>
						<?php if($vo['appoint_time'] == $todaytime): ?><a class="js-ajax-treatment" href='<?php echo U("Treatment/treatment",array('order_id'=>$vo['order_id'],'doctor_id'=>$vo['doctor_id']));?>'>是否已就诊</a> 
						<?php else: ?>
						等待就诊<?php endif; ?>
					</td>
