...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			<li><a href="<?php echo U('Disease/index');?>">疾病信息</a></li>
			<li><a href="<?php echo U('Disease/add');?>">添加</a></li>
			<li class="active"><a href="javascript:;">编辑</a></li>
		</ul>
		<form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('Disease/edit_post');?>">
			<fieldset>
				<div class="control-group">
					<label class="control-label">疾病名称:</label>
					<div class="controls form-group">
						<input type="text" name="disease_name" value="<?php echo ($disease["disease_name"]); ?>">
				...
				<div class="control-group">
					...
					<div class="controls form-group">
						<select name="bdept_id">
							...
							<?php if(is_array($dept)): foreach($dept as $key=>$dp): ?><option value="<?php echo ($dp["bdept_id"]); ?>" <?php if($dp['bdept_id'] == $disease['bdept_id']): ?>selected<?php endif; ?>><?php echo ($dp["bdept_name"]); ?></option><?php endforeach; endif; ?>
						</select>
					</div>
				</div>	
				<div class="control-group">
					...
					<div class="controls form-group">
						<input type="text" name="disease_contactor" value="<?php echo ($disease["disease_contactor"]); ?>">
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">手机话:</label>
					<div class="controls form-group">
						<input type="text" name="disease_mobile" value="<?php echo ($disease["disease_mobile"]); ?>">
					</div>
				</div>	
			</fieldset>
