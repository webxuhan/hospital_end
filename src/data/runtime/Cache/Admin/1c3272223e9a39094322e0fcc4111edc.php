...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="<?php echo U('BigDept/add');?>">添加</a></li>
		</ul>
		<form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('BigDept/add_post');?>">
			<fieldset>
				<div class="control-group">
					<label class="control-label">科室名称:</label>
					<div class="controls form-group">
						<input type="text" name="bdept_name">
				...
				<div class="control-group">
					...
					<div class="controls form-group">
						<input type="text" name="bdept_number">
						<span style="color:red;">保存后不可更改，请注意填写</span>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">联系人:</label>
					<div class="controls form-group">
						<input type="text" name="bdept_contactor">
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">手机话:</label>
					<div class="controls form-group">
						<input type="text" name="bdept_mobile">
					</div>
				</div>	
			</fieldset>
