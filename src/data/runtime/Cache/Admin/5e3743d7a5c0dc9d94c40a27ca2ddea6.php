...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo U('Treatment/notreat');?>">逾期未就诊</a></li>
		</ul>
		<form class="well form-search" method="post" action="<?php echo U('Treatment/notreat');?>">
			<table>
				<tr>
					<td>挂号单号:</td>
					<td>
		            ...
		            <a class="btn btn-danger" href="<?php echo U('Treatment/notreat');?>">清空</a>
		            </td>       
	            </tr>
            </table>
		...
		<form class="js-ajax-form" action="<?php echo U('Treatment/notreat');?>" method="post" id="form2">
