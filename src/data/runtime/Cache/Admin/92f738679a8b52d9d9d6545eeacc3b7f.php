...
<link href="/hospital_end/src/public/simpleboot/font-awesome/4.4.0/css/font-awesome.min.css?page=index"  rel="stylesheet" type="text/css">
<!--[if IE 7]>
	<link rel="stylesheet" href="/hospital_end/src/public/simpleboot/font-awesome/4.4.0/css/font-awesome-ie7.min.css">
<![endif]-->
<link rel="stylesheet" href="/hospital_end/src/public/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/simplebootadminindex.min.css?">
<link href="/hospital_end/src/public/js/artDialog/skins/default.css" rel="stylesheet" />
<!--[if lte IE 8]>
	<link rel="stylesheet" href="/hospital_end/src/public/simpleboot/css/simplebootadminindex-ie.css?" />
<![endif]-->
<style>
...
<body style="min-width:900px;" screen_capture_injected="true">
	...
	<div id="right_tools_wrapper">
		...
		<span id="right_tools_clearcache" title="显示顶栏" onclick="javascript:$('.navbar').slideToggle();"><i class="fa fa-sheqel right_tool_icon"></i></span>
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<div class="pull-left nav_shortcuts" >
					...
					<a class="btn btn-small btn-warning" href="/hospital_end/src/" title="<?php echo L('WEBSITE_HOME_PAGE');?>" target="_blank">
				...
				<ul class="nav simplewind-nav pull-right">
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							...
							<?php else: ?>
								<img class="nav-user-photo" width="30" height="30" src="/hospital_end/src/admin/themes/simplebootx/Public/assets/images/logo-18.png" alt="<?php echo ($admin["user_login"]); ?>"><?php endif; ?>
	...
	<script src="/hospital_end/src/admin/themes/simplebootx/Public/assets/js/index.js"></script>
</body>
</html>