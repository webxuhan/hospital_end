...
return array (
  ...
  'ADMIN_APPOINT_INDEX' => '挂号情况',
  'ADMIN_BACKUP_DEFAULT' => '备份管理',
  'ADMIN_BACKUP_INDEX' => '数据备份',
  'ADMIN_BACKUP_INDEX_POST' => '提交数据备份',
  'ADMIN_BACKUP_RESTORE' => '数据还原',
  'ADMIN_BIGDEPT_DEFAULT' => '科室管理',
  'ADMIN_BIGDEPT_INDEX' => '科室分类',
  'ADMIN_DISEASE_INDEX' => '疾病分类',
  'ADMIN_DOCTIME_INDEX' => '工作时间',
  'ADMIN_DOCTORINFO_DEFAULT' => '医生档案',
  'ADMIN_DOCTORINFO_INDEX' => '基本信息',
  ...
  'ADMIN_NAVCAT_DEFAULT' => '前台菜单',
  'ADMIN_NAVCAT_EDIT_POST' => '提交编辑',
  'ADMIN_NAVCAT_INDEX' => '菜单分类',
  'ADMIN_OAUTHADMIN_INDEX' => '医院注册用户',
  'ADMIN_PATIENT_DEFAULT' => '病人记录',
  ...
  'ADMIN_PATIENT_INDEX' => '基本信息',
  'ADMIN_SETTING_CLEARCACHE' => '清除缓存',
  'ADMIN_SLIDE_DEFAULT' => '幻灯片',
  'ADMIN_AD_INDEX' => '网站广告',
  'ADMIN_REGISTRATION_INDEX' => '挂号预约',
  'ADMIN_LINK_INDEX' => '友情链接',
  'ADMIN_TREATMENT_INDEX' => '未就诊',
  'ADMIN_RECYCLE_DEFAULT' => '回收站',
  'ADMIN_TREATMENT_YETTREAT' => '已就诊',
  'ADMIN_TREATMENT_NOTREAT' => '逾期未就诊',
  'ADMIN_TREATMENT_CANCELTREAT' => '预约取消',
