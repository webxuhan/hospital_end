...
$configs= array(
        "LOAD_EXT_FILE"=>"extend,systemUtil,expressUtil",
        ...
        'MODULE_ALLOW_LIST'  => array('Admin','Portal','Asset','Express','System','Api','User','Wx','Comment','Qiushi','Tpl','Topic','Install','Bug','Better','Pay','Cas'),
