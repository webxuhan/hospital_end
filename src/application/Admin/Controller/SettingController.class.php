...
class SettingController extends AdminbaseController{
	...
	public function site_post(){
		if (IS_POST) {
            ...
            //mailroom     Add by PanF  2017-01-11   begin
            $configs["LABEL_PRINT"]=empty($options['label_print'])?0:1;
            $configs["DELIVERY_PRINT"]=empty($options['delivery_print'])?0:1;
            $configs["SEARCH_OPTION"]=empty($options['search_option'])?0:1;
            //mailroom     Add by PanF  2017-01-11   end
